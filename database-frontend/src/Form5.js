...
class Form5 extends React.Component{
    constructor(props) {
        ...
        this.state = {
            ...
            headerNames2 : ["Имя цеха", "Имя участка цеха", "Идентификационный номер работника", "Имя работника", "Фамилия работника"],
            rowArray2 : [{workshopName : "", workshopSectionName : "", workerId : "", firstName : "", secondName : ""}],
    ...
    sendForm = (event) => {
        ...
        fetch(`http://localhost:8080/form/4`,
            {
                method : "POST",
                mode : "cors",
                cache : "default",
            ...
            this.setState({rowArray : [response["status"]], rowArray2 : response["workshopPersonal"]});
        });
    }
                ...
                <form className={"row justify-content-center"}>
                    <div className={"row col-6 shadow-lg rounded-2"}>
                        <label htmlFor={`TypeCompanyField-${formNumber}`} className={"form-label"}>
                            <h4>Мастера из указанного цеха(ов):</h4>
                        </label>
