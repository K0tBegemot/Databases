...
class Form21 extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            ...
            testEquipmentTypeName : {isValid : false, value : ""},
    ...
    sendForm = (event) => {
        ...
        fetch(`http://localhost:8080/form/20`,
            {
                method : "POST",
                mode : "cors",
                cache : "default",
                ...
                <form className={"row justify-content-center"}>
                    <div className={"row col-6 shadow-lg rounded-2"}>
                        <label htmlFor={`TypeCompanyField-${formNumber}`} className={"form-label"}>
                            <h4>Тестировочное оборудование</h4>
                        </label>
                        <div id={`TypeCompanyField-${formNumber}`}>
                            <div>
                                ...
                                <ValidTypeField formNumber={formNumber} fieldNumber={0} changeForm={this.handleFormChange} nameField={"testEquipmentId"} label={"Идентификатор тестового оборудования:"} placeholder={"Введите уникальный идентификатор тестового оборудования"} changeValidity={this.handleValidity} valid={this.state.testEquipmentId.isValid}></ValidTypeField>
                                <ValidTypeField formNumber={formNumber} fieldNumber={0} changeForm={this.handleFormChange} nameField={"testEquipmentTypeName"} label={"Тип тестового оборудования:"} placeholder={"Введите тип тестового оборудования"} changeValidity={this.handleValidity} valid={this.state.testEquipmentTypeName.isValid}></ValidTypeField>
                                <ValidTypeField formNumber={formNumber} fieldNumber={0} changeForm={this.handleFormChange} nameField={"testLabName"} label={"Имя тестовой лаборатории:"} placeholder={"Введите имя тестовой лаборатории"} changeValidity={this.handleValidity} valid={this.state.testLabName.isValid}></ValidTypeField>
                                <div className={"row"}>
                                    <div className={"col"}>
