...
class Form7 extends React.Component{
    constructor(props) {
        ...
        this.state = {
            ...
            headerNames2 : ["Идентификационный номер изделия", "Имя тестовой лаборатории"],
            rowArray2 : [{unitId : "", testLabName : ""}],
    ...
    sendForm = (event) => {
        ...
        fetch(`http://localhost:8080/form/6`,
            {
                method : "POST",
                mode : "cors",
                cache : "default",
            ...
            this.setState({rowArray : [response["status"]], rowArray2 : response["testLabList"]});
        });
    }
